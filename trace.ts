import type { Component, Sample, State } from "./component.ts";
...
class Trace {
  ...
  getTraces(names: Array<string>) {
    let longestName = "";
    const waves: Record<string, [string, string]> = {};
  ...
  getSample(n: number, names: Array<string>) {
    return names.reduce((acc: Record<string, State>, signal) => {
